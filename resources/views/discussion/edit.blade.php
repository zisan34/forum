...
<div class="card">
	<div class="card-header text-center">Edit The Discussion: "{{$discussion->title}}"</div>
	<div class="card-body">
		@include('inc.errors')
		<form action="{{ route('discussion.update',['slug'=>$discussion->slug]) }}" method="POST">
			...
			<div class="form-group">
				...
				<textarea type="textarea" name="content" class="form-control" >{{$discussion->content}}</textarea>
			</div>
			@csrf
